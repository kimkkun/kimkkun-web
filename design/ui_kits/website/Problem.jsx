...
function Problem() {
  ...
  return (
    <section className="kk-section light" id="problem" data-screen-label="Problem">
      <div className="kk-container">
        <div className="kk-sec-head" data-reveal>
          <SectionLabel number="01" surface="light">Problem</SectionLabel>
          <h2 className="kk-sec-title">매출은 오르는데,<br />남는 게 없다.</h2>
        </div>
