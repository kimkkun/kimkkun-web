...
function Hero() {
  const { Button, SectionLabel } = window.KimKkunDesignSystem_b887a3;
  return (
    <section className="kk-hero" id="top">
      <div className="kk-container">
        ...
        <p className="kk-hero-lead" data-reveal>
          10년간 가게를 직접 운영하며 배운 것. 손님을 단골로, 단골을 팬으로
          만드는 건 친절이 아니라 시스템이다. 김꾼은 그 시스템을 쉽고 구체적으로,
          그리고 냉정하게 다룬다.
        </p>
        <div className="kk-hero-actions" data-reveal>
          <Button variant="primary" size="lg" href="#work">콘텐츠 보기</Button>
          <Button variant="ghost" size="lg" href="#view">김꾼의 관점</Button>
        </div>
